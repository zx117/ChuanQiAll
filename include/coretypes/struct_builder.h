 ...
 */
DECLARE_CQDAQ_INTERFACE(IStructBuilder, IBaseObject)
{
    /*!
...
CQDAQ_DECLARE_CLASS_FACTORY(LIBRARY_FACTORY, StructBuilder, IString*, name, ITypeManager*, typeManager)
CQDAQ_DECLARE_CLASS_FACTORY_WITH_INTERFACE(LIBRARY_FACTORY, StructBuilderFromStruct, IStructBuilder, IStruct*, struct_)
