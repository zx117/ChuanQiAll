...
#ifdef CQDAQ_TRACK_SHARED_LIB_OBJECT_COUNT
...
public:
    ...
    {
        if (equal == nullptr)
            return makeErrorInfo(CQDAQ_ERR_ARGUMENT_NULL, "Equal output parameter must not be null.");
    ...
    virtual ErrCode INTERFACE_FUNC toString(CharPtr* str) override
    {
        ...
        return MainInterface::CqDaqType(str);
    }
