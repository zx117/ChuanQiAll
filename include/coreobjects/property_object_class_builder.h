 ...
 */
DECLARE_CQDAQ_INTERFACE(IPropertyObjectClassBuilder, IBaseObject)
{
    /*!
     ...
     * @retval CQDAQ_ERR_ALREADYEXISTS if a property with the same name already added to the class.
     * @retval CQDAQ_ERR_INVALIDTYPE if the property is an object type and is not atomic.
     *
     ...
     * @retval CQDAQ_ERR_NOTFOUND if the property with `propertyName` is not a member of the class.
     */
