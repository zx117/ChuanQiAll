 ...
 */
DECLARE_CQDAQ_INTERFACE(IPropertyObjectClass, IType)
{
    /*!
     ...
     * @retval CQDAQ_ERR_NOTFOUND if the Property with name `propertyName` is not added to the class.
     * @retval CQDAQ_ERR_MANAGER_NOT_ASSIGNED if the parent name is set, but the Type manager is not available.
     */
