...
/*#
 * [interfaceSmartPtr(ISignalConfig, GenericSignalConfigPtr, "<cqdaq/signal_config_ptr.h>")]
 */
 ...
 */
DECLARE_CQDAQ_INTERFACE(IMirroredSignalConfig, ISignalConfig)
{
    /*!
     ...
     * @retval CQDAQ_ERR_NOTFOUND if the streaming source with the corresponding connection string is not
