 ...
 */
DECLARE_CQDAQ_INTERFACE(ILogger, IBaseObject)
{
    /*!
     ...
     * @retval CQDAQ_ERR_INVALIDPARAMETER if @p name is empty string.
     */
     ...
     * @param name The component's name.
     * @retval CQDAQ_ERR_NOTFOUND if a component with the specified @p name was not added.
     */
...
CQDAQ_DECLARE_CLASS_FACTORY(LIBRARY_FACTORY, Logger, IList*, sinks, LogLevel, level)
