...
/*#
 * [includeHeader("<cqdaq/removable.h>")]
 ...
 */
DECLARE_CQDAQ_INTERFACE(IComponent, IPropertyObject)
{
    /*!
     ...
     * @retval CQDAQ_IGNORED if "Active" is part of the component's list of locked attributes,
     ...
     * @retval CQDAQ_IGNORED if "Name" is part of the component's list of locked attributes,
     ...
     * @retval CQDAQ_IGNORED if "Description" is part of the component's list of locked attributes,
     ...
     * @retval CQDAQ_IGNORED if "Visible" is part of the component's list of locked attributes.
     *
     * Visible determines whether search/getter methods return find the component by default.
     */
