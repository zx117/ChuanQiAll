...
namespace
{
    bool appendChannelList(xpugi::xml_element elem, const std::vector<cq::InputChannelData>& channels)
    {
        if (channels.empty()) return true;

        cq::ChannelList list_generator;
...
namespace cq
{
    ...
    bool RegisterSoftwareChannel::parse(const char *xml_string)
    {
        ...
        if (!cq::strequal(node.name(), "RegisterSoftwareChannel"))
        {
            return false;
        }

        auto version = cq::getProtocolVersion(node);
    ...
    std::string RegisterSoftwareChannel::generate() const
    {
        ...
        cq::setProtocolVersion(register_elem, cq::Version(1,0));
    ...
    bool CreateSoftwareChannel::parse(const char *xml_string)
    {
        ...
        if (!cq::strequal(node.name(), "CreateSoftwareChannel"))
        {
            return false;
        }
    ...
    bool CreateSoftwareChannelResponse::parse(const char* xml_string)
    {
        *this = CreateSoftwareChannelResponse();
        ...
        if (!cq::strequal(node.name(), "CreateSoftwareChannelResponse"))
        {
            return false;
        }
    ...
    std::string CreateSoftwareChannelResponse::generate() const
    {
        ...
        cq::setProtocolVersion(response_elem, cq::Version(1, 0));
    ...
    bool QuerySoftwareChannelAction::parse(const char* xml_string)
    {
        ...
        if (!cq::strequal(node.name(), "QuerySoftwareChannelAction"))
        {
            return false;
        }
    ...
    bool QuerySoftwareChannelActionResponse::parse(const char* xml_string)
    {
        ...
        if (!cq::strequal(node.name(), "QuerySoftwareChannelActionResponse"))
        {
            return false;
        }
