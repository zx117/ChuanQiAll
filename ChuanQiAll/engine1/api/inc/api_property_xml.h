...
namespace cq
{
    ...
    struct Scalar
    {
        ...
        CQ_NODISCARD bool operator==(Scalar const& other) const;
    ...
    public:
        ...
        CQ_NODISCARD std::string getNodeName() const;

        CQ_NODISCARD bool operator==(Property const& other) const;
        CQ_NODISCARD bool sameValue(Property const& other) const;
         ...
         */
        CQ_NODISCARD bool isValid() const;
         ...
         */
        CQ_NODISCARD const std::string& getName() const;
        ...
        CQ_NODISCARD StringFormat getStringFormat() const;
         ...
         */
        CQ_NODISCARD const std::string& getStringValue() const;
         ...
         */
        CQ_NODISCARD int getIntValue() const;
         ...
         */
        CQ_NODISCARD unsigned int getUnsignedIntValue() const;
         ...
         */
        CQ_NODISCARD std::uint64_t getUnsignedInt64Value() const;
         ...
         */
        CQ_NODISCARD std::int64_t getInt64Value() const;
         ...
         */
        CQ_NODISCARD double getDoubleValue() const;
         ...
         */
        CQ_NODISCARD bool getBoolValue() const;
         ...
         */
        CQ_NODISCARD const Scalar& getScalarValue() const;
         ...
         */
        CQ_NODISCARD const DecoratedNumber& getDecoratedNumberValue() const;
         ...
         */
        CQ_NODISCARD const Range& getRangeValue() const;
         ...
         */
        CQ_NODISCARD const std::string& getEnumValue() const;
        /**
         * Returns the enum type of this property as string
         * If this property is not of type ENUM, an exception is thrown
         */
        CQ_NODISCARD const std::string& getEnumType()const;
        ...
        */
        CQ_NODISCARD DoubleList getDoubleListValue() const;
         ...
         */
        CQ_NODISCARD StringList getStringListValue() const;
        ...
        CQ_NODISCARD const Point& getPointValue() const;
        ...
        CQ_NODISCARD const Rational& getRationalValue() const;

        void setChannelIDValue(const ChannelID& value);

        CQ_NODISCARD ChannelID getChannelIDValue() const;

        void setChannelIDListValue(const ChannelIDList& value);

        CQ_NODISCARD ChannelIDList getChannelIDListValue() const;
        ...
        */
        CQ_NODISCARD std::string valueToString() const;
