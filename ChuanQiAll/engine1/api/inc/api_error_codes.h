#ifndef __API_ERROR_CODES__
#define __API_ERROR_CODES__
...
{
    // NOTE: the description strings should match those in the translation file "chuanqi_exceptions_en.ts", context PLUGIN_API
    ...
    ERROR_ID(INVALID_MODE,             GENERIC, 0x00000003, "The operation is not supported in the current chuanqi mode");
