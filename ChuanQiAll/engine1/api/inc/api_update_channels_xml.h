    ...
    */
    ...
    public:
        struct ChannelGroupInfo : equality_comparable<ChannelGroupInfo>
        {
            ...
            CQ_NODISCARD bool isGroup() const
            {
                return !m_group_name.empty();
            }

            CQ_NODISCARD bool isChannel() const
            {
            ...
            CQ_NODISCARD bool operator==(const ChannelGroupInfo& other) const
            {
        ...
        struct PluginChannelInfo : equality_comparable<PluginChannelInfo>
        {
            ...
            cq::UpdateConfigTelegram::ChannelConfig m_channel_config;

            explicit PluginChannelInfo(std::uint32_t local_id = std::numeric_limits<uint32_t>::max())
                : m_local_id(local_id)
                , m_channel_config(cq::UpdateConfigTelegram::PluginChannelInfo(local_id))
            {
            }
        ...
        CQ_NODISCARD UpdateChannelsTelegram::PluginChannelInfo* getChannel(std::uint32_t local_id);
        CQ_NODISCARD const UpdateChannelsTelegram::PluginChannelInfo* getChannel(std::uint32_t local_id) const;
        ...
        CQ_NODISCARD bool operator==(const UpdateChannelsTelegram& other) const;
    };
