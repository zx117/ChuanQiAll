...
namespace cq
{
    ...
    struct ChannelDataformat : equality_comparable<ChannelDataformat>
    {
        ...
        CQ_NODISCARD bool operator==(const ChannelDataformat& other) const
        {
        ...
        CQ_NODISCARD static std::string getSampleFormatString(SampleFormat f);
    };
    ...
    struct ChannelDataformatTelegram : equality_comparable<ChannelDataformatTelegram>
    {
        ...
        CQ_NODISCARD bool operator==(const ChannelDataformatTelegram& other) const
        {
