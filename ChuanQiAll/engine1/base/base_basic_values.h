#ifndef __BASE_BASIC_VALUES__
#define __BASE_BASIC_VALUES__
...
namespace cq
{
    ...
    {
    public:
        CQ_NODISCARD virtual bool PLUGIN_API getValue() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual std::uint64_t PLUGIN_API getValue() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual std::int64_t PLUGIN_API getValue() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual double PLUGIN_API getValue() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual double PLUGIN_API getReal() const = 0;
        CQ_NODISCARD virtual double PLUGIN_API getImaginary() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual double PLUGIN_API getX() const = 0;
        CQ_NODISCARD virtual double PLUGIN_API getY() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual const char* PLUGIN_API getEnumName() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getEnumValue() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual const char* PLUGIN_API getValue() const = 0;
        CQ_NODISCARD virtual int PLUGIN_API getLength() const = 0;
    ...
    public:
        CQ_NODISCARD virtual double PLUGIN_API getValue() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getUnit() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual double PLUGIN_API getMin() const = 0;
        CQ_NODISCARD virtual double PLUGIN_API getMax() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getMinUnit() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getMaxUnit() const = 0;
    ...
    public:
        ...
        CQ_NODISCARD virtual std::int64_t PLUGIN_API getNumerator() const = 0;
        CQ_NODISCARD virtual std::int64_t PLUGIN_API getDenominator() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getUnit() const = 0;
    ...
    public:
        CQ_NODISCARD virtual double PLUGIN_API getValue() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getPrefix() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getSuffix() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual std::uint64_t PLUGIN_API getCode() const = 0;
        CQ_NODISCARD virtual const char* PLUGIN_API getDescription() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual int PLUGIN_API getSize() const = 0;
        CQ_NODISCARD virtual const std::uint8_t* PLUGIN_API refData() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual IfXMLValue* PLUGIN_API getBlockDescription() const = 0;
        CQ_NODISCARD virtual int PLUGIN_API dataSize() const = 0;
        CQ_NODISCARD virtual const std::uint8_t* PLUGIN_API data() const = 0;
    ...
    {
    public:
        CQ_NODISCARD virtual IfXMLValue* PLUGIN_API getBlockListDescription() const = 0;
        CQ_NODISCARD virtual int PLUGIN_API getBlockCount() const = 0;
        CQ_NODISCARD virtual IfDataBlock* PLUGIN_API getBlock(int index) const = 0;
