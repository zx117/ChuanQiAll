...
namespace cq
{
    ...
    //UUID for plugins that are to be used in ChuanQi, which have to implement the IfPlugin interface.
    static const cq::UuidType ChuanQi_Plugin_Uuid =
      cq::generateUuidType(0xd1, 0x7e, 0x33, 0x04, 0x9b, 0x11, 0x4e, 0x34, 0xa9, 0x31, 0x3f, 0xfa, 0x92, 0x3d, 0x1b, 0x98);
