...
namespace detail
{
     ...
     */
    template <class T>
    CQ_NODISCARD detail::ApiObjectPtr<T> ptr(T* p)
    {
        return detail::ApiObjectPtr<T>(p);
    }

    template <class T>
    CQ_NODISCARD detail::ApiObjectPtr<T> ptr_add_ref(T* p)
    {
        return detail::ApiObjectPtr<T>(p, true);
    }

    template <class T, class O>
    CQ_NODISCARD detail::ApiObjectPtr<T> api_ptr_cast(const detail::ApiObjectPtr<O>& ptr)
    {
    ...
    template <class T, class O>
    CQ_NODISCARD detail::ApiObjectPtr<T> value_ptr_cast(const detail::ApiObjectPtr<O>& ptr)
    {
        detail::ApiObjectPtr<T> ret;
    ...
    template <class T, class O>
    CQ_NODISCARD detail::ApiObjectPtr<const T> value_ptr_cast(const detail::ApiObjectPtr<const O>& ptr)
    {
