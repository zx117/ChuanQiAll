 ...
 */
DECLARE_CQDAQ_INTERFACE(IPropertyObject, IBaseObject)
{
    /*!
     ...
     * @retval CQDAQ_ERR_NOTFOUND if a property with given `propertyName` is not part of the Property object.
     * @retval CQDAQ_ERR_ACCESSDENIED if the property is Read-only.
     * @retval CQDAQ_ERR_CONVERSIONFAILED if the `value` cannot be converted to the Value type of the Property.
     * @retval CQDAQ_ERR_INVALIDTYPE if the `value` is a list/dictionary/object with invalid keys/items/fields.
     * @retval CQDAQ_ERR_VALIDATE_FAILED if the Validator fails to validate the `value`.
     * @retval CQDAQ_ERR_COERCION_FAILED if the Coercer fails to coerce the `value`.
     * @retval CQDAQ_ERR_FROZEN if the Property object is frozen.
     * @retval CQDAQ_ERR_IGNORED if the `value` is the same as the default, or the previously written value.
     *
     ...
     * @retval CQDAQ_ERR_NOTFOUND if a property with given `propertyName` is not part of the Property object.
     * @retval CQDAQ_ERR_INVALIDPARAMETER if attempting to get a value at an index of a non-list Property.
     * @retval CQDAQ_ERR_OUTOFRANGE if attempting to get a value of a list Property at an out-of-bounds index.
     *
     ...
     * @retval CQDAQ_ERR_NOTFOUND if a Property with given `propertyName` is not part of the Property object.
     * @retval CQDAQ_ERR_INVALIDPROPERTY if the Property either has no Selection values, or the Selection values are not a list or dictionary.
     * @retval CQDAQ_ERR_INVALIDTYPE if the retrieved value does not match the Property's item type.
     *
     ...
     * @retval CQDAQ_ERR_NOTFOUND if the Property object does not contain the requested Property.
     *
     ...
     * @retval CQDAQ_ERR_INVALIDVALUE if the property has no name.
     * @retval CQDAQ_ERR_ALREADYEXISTS if a property with the same name is already part of the Property object.
     * @retval CQDAQ_ERR_FROZEN if the Property object is frozen.
     *
     ...
     * @retval CQDAQ_ERR_NOTFOUND if the Property object does not contain a Property named `propertyName`, or the
     ...
     * @retval CQDAQ_ERR_NOTFOUND if the Property object does not contain a Property named `propertyName`.
     *
 ...
 */
CQDAQ_DECLARE_CLASS_FACTORY(LIBRARY_FACTORY, PropertyObject)
