...
DECLARE_CQDAQ_INTERFACE(IEvalValue, IBaseObject)
{
    /*!
     ...
     * @retval CQDAQ_ERR_CALCFAILED when calculation failed.
     * @retval CQDAQ_ERR_RESOLVEFAILED when reference resolution failed
     * @retval CQDAQ_ERR_PARSEFAILED when expression parsing failed
     *
...
CQDAQ_DECLARE_CLASS_FACTORY(LIBRARY_FACTORY, EvalValue, IString*, eval)

CQDAQ_DECLARE_CLASS_FACTORY_WITH_INTERFACE(LIBRARY_FACTORY, EvalValueArgs, IEvalValue, IString*, eval, IList*, args)

CQDAQ_DECLARE_CLASS_FACTORY_WITH_INTERFACE(LIBRARY_FACTORY, EvalValueFunc, IEvalValue, IString*, eval, IFunction*, func)
