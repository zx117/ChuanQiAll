...
CQDAQ_DEFINE_CLASS_FACTORY(LIBRARY_FACTORY, EvalValue, IString*, eval)

CQDAQ_DEFINE_CLASS_FACTORY_WITH_INTERFACE_AND_CREATEFUNC(
    LIBRARY_FACTORY,
    EvalValue,
    IEvalValue,
    createEvalValueArgs,
...
CQDAQ_REGISTER_DESERIALIZE_FACTORY(EvalValueImpl)
