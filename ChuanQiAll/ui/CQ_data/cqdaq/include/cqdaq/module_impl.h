...
public:
    ...
    {
        CQDAQ_PARAM_NOT_NULL(moduleVersion);
    ...
    {
        CQDAQ_PARAM_NOT_NULL(moduleName);
    ...
    {
        CQDAQ_PARAM_NOT_NULL(serverTypes);
    ...
    {
        CQDAQ_PARAM_NOT_NULL(serverTypeId);
        CQDAQ_PARAM_NOT_NULL(rootDevice);
        CQDAQ_PARAM_NOT_NULL(server);
