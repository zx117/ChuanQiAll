 ...
 */
DECLARE_CQDAQ_INTERFACE(IDeviceInfoConfig, IDeviceInfo)
{
    /*!
...
CQDAQ_DECLARE_CLASS_FACTORY_WITH_INTERFACE(LIBRARY_FACTORY, DeviceInfoConfig, IDeviceInfoConfig, IString*, name, IString*, connectionString)
CQDAQ_DECLARE_CLASS_FACTORY_WITH_INTERFACE(LIBRARY_FACTORY, DeviceInfoConfigWithCustomSdkVersion, IDeviceInfoConfig, IString*, name, IString*, connectionString, IString*, sdkVersion)
