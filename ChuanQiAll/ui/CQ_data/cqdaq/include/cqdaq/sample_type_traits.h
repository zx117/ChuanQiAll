...
#define CQDAQ_DEFAULT_SAMPLE_TYPES CQDAQ_SAMPLE_TYPES(RawPtr, float,  double, uint8_t, int8_t, uint16_t, int16_t, uint32_t, int32_t, uint64_t, int64_t, RangeType64, ComplexFloat32, ComplexFloat64, BinarySample)
#define CQDAQ_VALUE_SAMPLE_TYPES   CQDAQ_SAMPLE_TYPES(        float,  double, uint8_t, int8_t, uint16_t, int16_t, uint32_t, int32_t, uint64_t, int64_t, RangeType64, ComplexFloat32, ComplexFloat64)
