...
public:
    ...
    {
        CQDAQ_PARAM_NOT_NULL(inputPort);
        CQDAQ_PARAM_NOT_NULL(signal);
        CQDAQ_PARAM_NOT_NULL(accept);
    ...
    {
        CQDAQ_PARAM_NOT_NULL(sampleType);
