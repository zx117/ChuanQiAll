 ...
 * field value. The Type objects at the moment available in cqDAQ are Simple types and Struct types. When adding any field other
 ...
 * types.
 */
DECLARE_CQDAQ_INTERFACE(IStructType, IType)
{
...
CQDAQ_DECLARE_CLASS_FACTORY(LIBRARY_FACTORY, StructType, IString*, name, IList*, names, IList*, defaultValues, IList*, types)
