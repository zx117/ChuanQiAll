...
inline ErrCode errorFromException(const std::exception& e, IBaseObject* source = nullptr, ErrCode errCode = CQDAQ_ERR_GENERALERROR)
{
...
ErrCode wrapHandler(Object* object, Handler handler, Params... params)
{
    ...
    catch (const std::exception& e)
    {
        ...
        return makeErrorInfo(CQDAQ_ERR_GENERALERROR, e.what(), baseObject);
    }
    catch (...)
    {
        return CQDAQ_ERR_GENERALERROR;
