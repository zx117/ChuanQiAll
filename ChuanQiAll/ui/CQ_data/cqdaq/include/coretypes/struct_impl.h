    ...
    ISerializedObject* ser, IBaseObject* context, IFunction* factoryCallback, IBaseObject** obj)
{
    ...
    if (context == nullptr || CQDAQ_FAILED(context->queryInterface(ITypeManager::Id, reinterpret_cast<void**>(&typeManager))))
        return CQDAQ_ERR_NO_TYPE_MANAGER;
...
CQDAQ_REGISTER_DESERIALIZE_FACTORY(StructImpl)
