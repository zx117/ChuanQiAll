 ...
 *
 * The Struct types are stored within a Type manager. In any given instance of cqDAQ, a single Type manager should
 ...
 *
 * Structs are an cqDAQ core type (ctStruct). Several objects in cqDAQ such as an Unit, or DataDescriptor are Structs,
 ...
 * types.
 */
DECLARE_CQDAQ_INTERFACE(IStruct, IBaseObject)
{
    /*!
...
CQDAQ_DECLARE_CLASS_FACTORY(LIBRARY_FACTORY, Struct, IString*, name, IDict*, fields, ITypeManager*, typeManager)
CQDAQ_DECLARE_CLASS_FACTORY_WITH_INTERFACE(LIBRARY_FACTORY, StructFromBuilder, IStruct, IStructBuilder*, builder)
