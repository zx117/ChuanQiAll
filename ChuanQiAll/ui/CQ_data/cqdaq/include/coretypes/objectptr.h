...
public:
     ...
     * If it expects multiple parameters, pass a list of cqDAQ objects as the `params` parameter.
     */
...
{
    return compareObjectPtr<T, U, CQDAQ_EQUAL>(lhs, rhs);
}
...
bool operator>(const ObjectPtr<T>& lhs, const ObjectPtr<U>& rhs)
{
    return compareObjectPtr<T, U, CQDAQ_GREATER>(lhs, rhs);
}

template <class T, class U>
bool operator<(const ObjectPtr<T>& lhs, const ObjectPtr<U>& rhs)
{
    return compareObjectPtr<T, U, CQDAQ_LOWER>(lhs, rhs);
}

template <class T, class U>
bool operator>=(const ObjectPtr<T>& lhs, const ObjectPtr<U>& rhs)
{
    return (compareObjectPtr<T, U, CQDAQ_GREATER>(lhs, rhs) || compareObjectPtr<T, U, CQDAQ_EQUAL>(lhs, rhs));
}

template <class T, class U>
bool operator<=(const ObjectPtr<T>& lhs, const ObjectPtr<U>& rhs)
{
    return (compareObjectPtr<T, U, CQDAQ_LOWER>(lhs, rhs) || compareObjectPtr<T, U, CQDAQ_EQUAL>(lhs, rhs));
}
...
{
    Bool eq{};
    return (a == b) || (a != nullptr && CQDAQ_SUCCEEDED(a->equals(b, &eq)) && eq);
}
